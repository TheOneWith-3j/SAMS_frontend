...
const Admin = () => {
    ...
    useEffect(() => {
        ...
        axios.get('${process.env.REACT_APP_BACKEND_URL}/auth/validate', {
            headers: {
    ...
    const loadDashboardData = () => {
        ...
        // all Counts
        axios.get('${process.env.REACT_APP_BACKEND_URL}/admin/data/count/all', {
            headers: {
                'user_id': localStorage.getItem('user_id'),
                'x-access-token': localStorage.getItem('token'),
            }
        ...
        // 15 days Count
        axios.get('${process.env.REACT_APP_BACKEND_URL}/admin/data/count/15', {
            headers: {
                'user_id': localStorage.getItem('user_id'),
                'x-access-token': localStorage.getItem('token'),
            }
        ...
        axios.get('${process.env.REACT_APP_BACKEND_URL}/admin/data/count/institution-wise', {
            headers: {
                'user_id': localStorage.getItem('user_id'),
                'x-access-token': localStorage.getItem('token'),
            }
         ...
         axios.get('${process.env.REACT_APP_BACKEND_URL}/admin/data/count/group', {
            headers: {
                'user_id': localStorage.getItem('user_id'),
                'x-access-token': localStorage.getItem('token'),
            }
