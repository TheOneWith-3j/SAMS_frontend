...
const columns01: GridColDef[] = [
    ...
    { field: 'q_38', headerName: 'What are the significant contributions made by your institution to the support functions eg HR, IT, Sports, Security, PR, AR etc', width: 200 },
    {
        field: 'supportings', headerName: 'Supportings', width: 200, renderCell: (params) => {
            return <a href={`${process.env.REACT_APP_BACKEND_URL}/${params.value ? params.value.split("data")[1] : null}`} className="p-2 rounded-2xl cursor-pointer bg-red-700 text-white font-Poppins" target='_blank' download>Download</a>;
        }
    },
...
const columns03: GridColDef[] = [
    ...
    {
        field: 'supportings', headerName: 'Supportings', width: 200, renderCell: (params) => {
            return <a target="_blank" href={`${process.env.REACT_APP_BACKEND_URL}/${params.value ? params.value.split("data")[1] : null}`} className="p-2 rounded-2xl cursor-pointer bg-red-700 text-white font-Poppins" download>Download</a>;
        }
    },
];
